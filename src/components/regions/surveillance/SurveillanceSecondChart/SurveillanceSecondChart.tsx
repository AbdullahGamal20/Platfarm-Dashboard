...
const quarterlyData = [
  ...
  { quarter: "Quarter 5", amount: 15000 }, // Added extra data for testing
  { quarter: "Quarter 6", amount: 20000 },
  { quarter: "Quarter 7", amount: 18000 }, // Added extra data for testing
  { quarter: "Quarter 8", amount: 25000 },
];
...
const monthlyData = [
  ...
  { quarter: "Month 5", amount: 11000 }, // Added extra data for testing
  { quarter: "Month 6", amount: 6000 },
  { quarter: "Month 7", amount: 12000 }, // Added extra data for testing
  { quarter: "Month 8", amount: 9000 },
];
...
const weeklyData = [
  ...
  { quarter: "Week 5", amount: 3000 }, // Added extra data for testing
  { quarter: "Week 6", amount: 9000 },
  { quarter: "Week 7", amount: 2500 }, // Added extra data for testing
  { quarter: "Week 8", amount: 6000 },
];

const SurveillanceSecondChart = () => {
    ...
    <Card className="w-full bg-transparent outline-none border-none shadow-none relative">
      ...
      <CardContent className="w-full h-[310px]">
        ...
        >
          ...
          <AreaChart
            data={visibleData} // Use visibleData for chart
            margin={{
              top: 20,
              left: 0,
              right: 0,
            ...
            barSize={50} // Set the fixed width of the bars
          >
            <defs>
...
export default SurveillanceSecondChart;
